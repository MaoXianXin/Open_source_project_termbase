...
18. Apache RocketMQ，现为Apache 顶级项目，是生于云、长于云的新一代“消息、事件、流”融合处理平台。坚持面向场景、面向失败、松散耦合的极简弹性架构，无外部依赖，运维友好，开箱即用，具备低延迟、高并发、高可用、高可靠的优势，具有灵活的可扩展性、海量消息堆积能力、支持顺序消息、支持多种消息过滤方式、支持事务消息等特性，已成为微服务领域业务消息的首选。同时，Apache RocketMQ 提供轻量级实时计算能力，具有轻量化、高性能和低成本等优势，为用户提供更为一致的流批一体实时数据处理体验。